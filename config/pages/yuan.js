    ...
    content: `
        <div style="max-width: 100%; margin: 0 auto;">
            ...
            <div class="yuan-intro">
                <p class="yuan-lead">
                    「Yuàn/願」是我們的核心哲學，象徵一切的原點與願力。
                </p>
                <p class="yuan-copy">
                    透過科技，我們重塑了觀看的結構；透過藝術，我們找回了感知的溫度。
                </p>
            </div>
            
            <!-- 元光寺專案 Section -->
            <h3 class="yuan-section-title">元光寺專案 (Yuan Guang Temple Project)</h3>
            ...
            <div class="gallery-grid yuan-project-grid">
                ...
                <div class="gallery-item project-item">
                    ...
                    <div class="item-info" style="padding: 1rem;">
                        ...
                        <p style="font-size: 0.9rem; color: #666; margin-top: 0.5rem;">改編自王世堅經典金句「沒出息」。feat.普獻上人青年相貌。</p>
                    </div>
                </div>
                ...
                <div class="gallery-item project-item">
                    ...
                    <div class="item-info" style="padding: 1rem;">
                        ...
                        <p style="font-size: 0.9rem; color: #666; margin-top: 0.5rem;">「我就像這個花草樹木，開花、結果、掉下來，化作春泥， 就這樣就好了。」</p>
                    </div>
                </div>
            ...
            <h3 class="yuan-section-title" style="margin-top:3rem;">實驗影音紀錄 (Experiments)</h3>
